        ...
        <main>
            ...
            <section className="max-w-screen-xl mx-auto p-8 bg-white rounded mt-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-700 mt-4">En nuestro spa, entendemos que cada persona es única y merece un tratamiento que se ajuste a sus necesidades individuales. La diversidad de nuestras masajistas garantiza que encontrarás la técnica y el estilo que mejor se adapten a ti, brindándote una experiencia de bienestar personalizada y memorable. Ven y descubre cuál de nuestras masajistas florece contigo.</p>

                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {
                        flowersList.map((flower, index) => {
                            return (<div key={flower.name} className="rounded-lg overflow-hidden shadow-lg bg-white md:bg-transparent md:shadow-none hover:shadow-lg hover:bg-white">
